...
function run(listedStatus)
{
	if(!listedStatus)
	{
		...
		var injectedCode = [
			...
			'backup.productSub = window.navigator.productSub;',
			'backup.vendor = window.navigator.vendor;',
			'backup.vendorSub = window.navigator.vendorSub;',
			'backup.webkitPointer = window.navigator.webkitPointer;',
			...
			'backup.requestWakeLock = window.navigator.requestWakeLock;',
			'backup.webkitPersistentStorage = window.navigator.webkitPersistentStorage;',
			'backup.webkitTemporaryStorage = window.navigator.webkitTemporaryStorage;',
			'backup.getStorageUpdates = window.navigator.getStorageUpdates;',
			'backup.webkitGetGamepads = window.navigator.webkitGetGamepads;',
			'backup.webkitGetUserMedia = window.navigator.webkitGetUserMedia;',
			'',
